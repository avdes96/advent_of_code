...
def get_data(filename: str) -> list[Ingredient]:
    ...
    with open(filename) as f:
        for line in f:
            ...
            assert mtch is not None, f"'{line}' is not in expected form."
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Advent of Code 2015 - Day 15")
    parser.add_argument("input_filename", type=str, help="File containing problem input.")
    args = parser.parse_args()
    filename = args.input_filename
    ingredients = get_data(filename)
